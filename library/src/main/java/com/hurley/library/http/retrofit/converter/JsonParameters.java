package com.hurley.library.http.retrofit.converter;
...
import com.hurley.library.http.retrofit.converter.ValueDefaultParameters.Default;
...
public final class JsonParameters {
    ...
    interface Service {
        @FormUrlEncoded
        @POST("/filter")
        Call<ResponseBody> example(@Default("default") @Field("de") String de);
    }
