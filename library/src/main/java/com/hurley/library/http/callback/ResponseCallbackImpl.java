...
import com.hurley.library.http.GsonManager;
import com.hurley.library.http.model.BaseObject;
...
public abstract class ResponseCallbackImpl<GSON_TYPE> extends ResponseCallback<GSON_TYPE> {
     ...
     */
    @Override
    public abstract boolean onFail(int statusCode, @Nullable GSON_TYPE failDate, @Nullable Throwable error);
