package com.hurley.library.http;


import com.hurley.library.http.security.NHX509TrustManager;
...
public class TrustUtils {
    ...
    public static SSLSocketFactory getTrustSslSocketFactory(InputStream[] certificates, InputStream bksFile, String password) {
        try {
    ...
    public static X509TrustManager getX509TrustManager(InputStream[] certificates) {
        TrustManager[] trustManagers = prepareTrustManager(certificates);
        try {
            new HttpTrustManager(chooseTrustManager(trustManagers));
    ...
    private static class HttpTrustManager implements X509TrustManager {
