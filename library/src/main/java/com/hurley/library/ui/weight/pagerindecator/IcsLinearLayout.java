...
class IcsLinearLayout extends LinearLayout {
    ...
    public IcsLinearLayout(Context context, int themeAttr) {
        ...
        setDividerDrawable(a.getDrawable(LL[LL_DIVIDER]));
        mDividerPadding = a.getDimensionPixelSize(LL[LL_DIVIDER_PADDING], 0);
        mShowDividers = a.getInteger(LL[LL_SHOW_DIVIDER], SHOW_DIVIDER_NONE);
        a.recycle();
    }
    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        final LinearLayout.LayoutParams params = (LayoutParams) child.getLayoutParams();
